...
all_creds = read_credentials('/home/pvm/project/cred.txt')
...
# Attempt to open the Excel workbook using LibreOffice
try:
    subprocess.run(['libreoffice', '--calc', excel_filename])
    print("Opening Excel file with LibreOffice...")
